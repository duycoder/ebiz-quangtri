...
{
    public class VanBanThamGiaXuLyController : BaseController
    {
        // GET: HSVanBanDiArea/VanBanThamGiaXuLy
        ...
        public ActionResult Index()
        {
            ...
            model.ListResult = HSCV_VANBANDIBusiness.GetListJoinProcessing(searchModel, MaxPerpage);
            model.UserInfoBO = currentUser;
            SessionManager.SetValue("VbThamGiaXuLy", searchModel);
            return View(model);
        }
        ...
        {
            HSCV_VANBANDIBusiness = Get<HSCV_VANBANDIBusiness>();
            var searchModel = SessionManager.GetValue("VbThamGiaXuLy") as HSCV_VANBANDI_SEARCH;
            ...
            var data = HSCV_VANBANDIBusiness.GetListJoinProcessing(searchModel, pageSize, indexPage);
            return Json(data);
        }
        public JsonResult searchData(FormCollection form)
        {
            ...
            var data = HSCV_VANBANDIBusiness.GetListJoinProcessing(searchModel, searchModel.pageSize, 1);
            return Json(data);
        }
    }
}