...
{
    public class VanBanDaReviewController : BaseController
    {
        // GET: /HSVanBanDiArea/VanBanDaReview
        ...
        {
            HSCV_VANBANDIBusiness = Get<HSCV_VANBANDIBusiness>();
            var searchModel = SessionManager.GetValue("VbReview") as HSCV_VANBANDI_SEARCH;
